...
import {NewBaseDirective, StyleUtils, MediaMarshaller} from '@angular/flex-layout/core';

export class ClassDirective extends NewBaseDirective implements DoCheck {
